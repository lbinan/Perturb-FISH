...
def scale_effs(B, logmeanexp, downsample_num = 25000, log_exp_baseline = 2.7):#244/10000*653 ||log( exp(5.5) mean couts/cells e
    '''
...
MASTHEAD = "*********************************************************************\n"
MASTHEAD += "* Factorize-Recover for Perturb-seq NO NORM analysis (FR-Perturb)\n"
