...
%         thisImage=double(thisImage(:,:,24))/7500;
    ...
    globalindex=sub2ind([size(seedsmosaic,1) size(seedsmosaic,2)],1+merfishcoo(:,2),1+merfishcoo(:,1));
...
save(fullfile(matlabtempfiles,'globalmerfishspotsregion0optiSmallRotation2fixed.mat'),'globalmerfishspots','-v7.3')
