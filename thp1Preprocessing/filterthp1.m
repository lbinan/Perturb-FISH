...
filtered='/broad/clearylab/Users/Loic/thp1homemadezombie_1/filteredagain'
...
for fov=1:size(myfovs,2)
    ...
    imageround1=double(ReadDax(fullfile(localpath,thisfilesname)));
    for thiscycle=1:4
         if thisFOV<10
        ...
        if thiscycle==1
            imageround2=registerImagesHIgerpass(imageround1,double(myimage));
        elseif thiscycle==2
            imageround3=registerImagesHIgerpass(imageround1,double(myimage));
        elseif thiscycle==3
            imageround4=registerImagesHIgerpass(imageround1,double(myimage));
        elseif thiscycle==4
            imageround5=registerImagesHIgerpass(imageround1,double(myimage));
        end
    end
    ...
    imwrite(max(imageround1(:,:,16:21),[],3)/25,fullfile(filtered,strcat(croppedfilename,'3.tif')));
    imwrite(max(imageround2(:,:,2:7),[],3)/5,fullfile(filtered,strcat(croppedfilename,'4.tif')));
    imwrite(max(imageround2(:,:,8:13),[],3)/5,fullfile(filtered,strcat(croppedfilename,'5.tif')));
    imwrite(max(imageround2(:,:,16:21),[],3)/25,fullfile(filtered,strcat(croppedfilename,'6.tif')));
    imwrite(max(imageround3(:,:,2:7),[],3)/5,fullfile(filtered,strcat(croppedfilename,'7.tif')));
    imwrite(max(imageround3(:,:,8:13),[],3)/5,fullfile(filtered,strcat(croppedfilename,'8.tif')));
    imwrite(max(imageround3(:,:,16:21),[],3)/25,fullfile(filtered,strcat(croppedfilename,'9.tif')));
    imwrite(max(imageround4(:,:,2:7),[],3)/5,fullfile(filtered,strcat(croppedfilename,'10.tif')));
    imwrite(max(imageround4(:,:,8:13),[],3)/5,fullfile(filtered,strcat(croppedfilename,'11.tif')));
    imwrite(max(imageround4(:,:,16:21),[],3)/15,fullfile(filtered,strcat(croppedfilename,'12.tif')));
    imwrite(max(imageround5(:,:,2:7),[],3)/5,fullfile(filtered,strcat(croppedfilename,'13.tif')));
    imwrite(max(imageround5(:,:,8:13),[],3)/5,fullfile(filtered,strcat(croppedfilename,'14.tif')));
    imwrite(max(imageround5(:,:,16:21),[],3)/5,fullfile(filtered,strcat(croppedfilename,'15.tif')));
end
