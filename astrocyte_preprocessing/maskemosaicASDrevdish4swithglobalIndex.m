...
barcodes=readtable('/broad/clearylab/Users/Loic/ASDMerfishRevs4/analysed/202402221355_ASDRevsDish4Merfish_VMSC11302/ExportBarcodes/region_0/barcodes.csv');
...
for fov=1:size(myfovs,2)
    ...
    if thisFOV<10
        ...
        thisImage=double(thisImage(:,:,24))/3000;
    elseif thisFOV<100
        thispath=(fullfile(mypath,strcat('stack_0_00',num2str(thisFOV),'.inf')));
    ...
    split=bwareaopen(nuclei,35000)|bwpropfilt(nuclei,'Solidity',[0,0.9]);
    keep=(nuclei-split)>0;
