function thisout=registerThatFOV(thisFOV)% mypath='/broad/clearylab/Users/Loic/loicAsdRev2_zombie/Data'%path to raw images (dax files)
...
mypath='/broad/clearylab/Users/Loic/loicAsdRev2_zombie/Data'
 localpath=mypath
% myfovs=[1122:1123];
% delete(gcp('nocreate'))

thistempfilesname='blank_0001.dax'
background1=double(ReadDax(fullfile(blankpath,thistempfilesname)));
thistempfilesname='test_0002.dax'
background2=double(ReadDax(fullfile(blankpath,thistempfilesname)));
for i=1:21
...
filteredimage=zeros(2048,2048,21);
% thisFOV=myfovs(fov);
if thisFOV<10
    thistempfilesname=strcat('bicolorhal-config-749z7-638z7-477z7-405z7_000',num2str(thisFOV),'.dax');
elseif thisFOV<100
    thistempfilesname=strcat('bicolorhal-config-749z7-638z7-477z7-405z7_00',num2str(thisFOV),'.dax');
elseif thisFOV<1000
    thistempfilesname=strcat('bicolorhal-config-749z7-638z7-477z7-405z7_0',num2str(thisFOV),'.dax');
else
    thistempfilesname=strcat('bicolorhal-config-749z7-638z7-477z7-405z7_',num2str(thisFOV),'.dax');
end
imageround0=double(ReadDax(fullfile(localpath,thistempfilesname)));
for thiscycle=1:11
     if thisFOV<10
         if thiscycle<11
             thistempfilesname=strcat('bicolorhal-config-749z7-638z7-477z1-405z1_000',num2str(thisFOV),'_0',num2str(thiscycle-1),'.dax');
         else
             thistempfilesname=strcat('bicolorhal-config-749z7-638z7-477z1-405z1_000',num2str(thisFOV),'_',num2str(thiscycle-1),'.dax');
         end
    elseif thisFOV<100
         if thiscycle<11
             thistempfilesname=strcat('bicolorhal-config-749z7-638z7-477z1-405z1_00',num2str(thisFOV),'_0',num2str(thiscycle-1),'.dax');
         else
             thistempfilesname=strcat('bicolorhal-config-749z7-638z7-477z1-405z1_00',num2str(thisFOV),'_',num2str(thiscycle-1),'.dax');
         end
    elseif thisFOV<1000
         if thiscycle<11
            thistempfilesname=strcat('bicolorhal-config-749z7-638z7-477z1-405z1_0',num2str(thisFOV),'_0',num2str(thiscycle-1),'.dax');
         else
            thistempfilesname=strcat('bicolorhal-config-749z7-638z7-477z1-405z1_0',num2str(thisFOV),'_',num2str(thiscycle-1),'.dax');
         end
    else
         if thiscycle<11
            thistempfilesname=strcat('bicolorhal-config-749z7-638z7-477z1-405z1_',num2str(thisFOV),'_0',num2str(thiscycle-1),'.dax');
         else
            thistempfilesname=strcat('bicolorhal-config-749z7-638z7-477z1-405z1_',num2str(thisFOV),'_',num2str(thiscycle-1),'.dax');   
         end
     end
    thatfilename=thistempfilesname;
    myimage=ReadDax(fullfile(localpath,thistempfilesname));
    if thiscycle==1
...
for i=1:21%images are divided by the average blank to compensate for the shape of the excitation light
...
for frame=1:21%images are gaussian filtered to enhance signal and remove background
...
croppedfilename=thistempfilesname(1:end-6);%rename
