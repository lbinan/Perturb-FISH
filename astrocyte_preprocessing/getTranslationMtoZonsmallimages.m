...
merfish2 = double(merfishObject.cellsmosaic(100000:151000,10000:20000)); %bottom left part of S2R1, becomes top left after flip
...
tform=tformlarge;
save(fullfile(matlabtempfiles,'tformMerfS2R0TOzombietopFromreducedImages.mat'),'tform','-v7.3')
