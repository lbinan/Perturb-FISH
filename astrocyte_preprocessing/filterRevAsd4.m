mypath='/broad/clearylab/Users/Loic/ASdRevsZombiedish4/Data'%path to raw images (dax files)
filtered='/broad/clearylab/Users/Loic/ASdRevsZombiedish4/filtered'%output path
matlabtempfiles='/broad/clearylab/Users/Loic/ASdRevsZombiedish4/matlabtempfiles'
...
% imageround1=zeros(2048,2048,21);
% imageround2=zeros(2048,2048,21);
% imageround3=zeros(2048,2048,21);
% imageround4=zeros(2048,2048,21);
% imageround5=zeros(2048,2048,21);
% imageround6=zeros(2048,2048,21);
% imageround7=zeros(2048,2048,21);
% imageround8=zeros(2048,2048,21);
% imageround9=zeros(2048,2048,21);
% imageround10=zeros(2048,2048,21);
% imageround11=zeros(2048,2048,21);
thisFOV=myfovs(fov);
if thisFOV<10
...
for thiscycle=1:11
    ...
    elseif thiscycle==9
        imageround9=registerRevsImages(imageround0,double(myimage));
    elseif thiscycle==10
        imageround10=registerRevsImages(imageround0,double(myimage));
    elseif thiscycle==11
        imageround11=registerRevsImages(imageround0,double(myimage));
    end
end
...
imwrite(max(imageround1(:,:,10:13),[],3)/5,fullfile(filtered,strcat(croppedfilename,'2.tif')));

imwrite(max(imageround2(:,:,2:7),[],3)/5,fullfile(filtered,strcat(croppedfilename,'3.tif')));
imwrite(max(imageround2(:,:,10:13),[],3)/5,fullfile(filtered,strcat(croppedfilename,'4.tif')));

imwrite(max(imageround3(:,:,2:7),[],3)/5,fullfile(filtered,strcat(croppedfilename,'5.tif')));
imwrite(max(imageround3(:,:,10:13),[],3)/5,fullfile(filtered,strcat(croppedfilename,'6.tif')));

imwrite(max(imageround4(:,:,2:7),[],3)/5,fullfile(filtered,strcat(croppedfilename,'7.tif')));
imwrite(max(imageround4(:,:,10:13),[],3)/5,fullfile(filtered,strcat(croppedfilename,'8.tif')));

imwrite(max(imageround5(:,:,2:7),[],3)/5,fullfile(filtered,strcat(croppedfilename,'9.tif')));
imwrite(max(imageround5(:,:,10:13),[],3)/5,fullfile(filtered,strcat(croppedfilename,'10.tif')));

imwrite(max(imageround6(:,:,2:7),[],3)/5,fullfile(filtered,strcat(croppedfilename,'11.tif')));
imwrite(max(imageround6(:,:,10:13),[],3)/5,fullfile(filtered,strcat(croppedfilename,'12.tif')));

imwrite(max(imageround7(:,:,2:7),[],3)/5,fullfile(filtered,strcat(croppedfilename,'13.tif')));
imwrite(max(imageround7(:,:,10:13),[],3)/5,fullfile(filtered,strcat(croppedfilename,'14.tif')));

imwrite(max(imageround8(:,:,2:7),[],3)/5,fullfile(filtered,strcat(croppedfilename,'15.tif')));
imwrite(max(imageround8(:,:,10:13),[],3)/5,fullfile(filtered,strcat(croppedfilename,'16.tif')));

imwrite(max(imageround9(:,:,2:7),[],3)/5,fullfile(filtered,strcat(croppedfilename,'17.tif')));
imwrite(max(imageround9(:,:,10:13),[],3)/5,fullfile(filtered,strcat(croppedfilename,'18.tif')));

imwrite(max(imageround10(:,:,2:7),[],3)/5,fullfile(filtered,strcat(croppedfilename,'19.tif')));
imwrite(max(imageround10(:,:,10:13),[],3)/5,fullfile(filtered,strcat(croppedfilename,'20.tif')));

imwrite(max(imageround11(:,:,10:13),[],3)/5,fullfile(filtered,strcat(croppedfilename,'21.tif')));
end
% end
% end
...
delete(gcp('nocreate'))
disp('got here')
decodeRevsastrocytesdish4
% spotsQCastrocyteAsd4revs
